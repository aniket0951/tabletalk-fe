    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-[380px]">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-accent text-xl">
            🍽
          </div>
          ...
          <div className="mt-1 text-sm text-text2">
            Enter your restaurant code and PIN
          </div>
        </div>

        <form
          onSubmit={handleLogin}
          className="overflow-hidden rounded-[14px] border border-border bg-surface shadow-[0_1px_3px_rgba(0,0,0,.07)]"
        >
          <div className="p-5">
            {error && (
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setRestaurantCode(e.target.value.toUpperCase().slice(0, 6))
                }
                autoFocus
              />
            </div>
