...
const campaignTypes: {
...
}[] = [
  {
    ...
    label: "Discount",
    emoji: "🏷",
    desc: "Offer % or flat discount",
  },
  {
    key: "NEW_DISH",
    label: "New Dish",
    emoji: "🍽",
    desc: "Announce a new item",
  },
  {
    key: "FESTIVAL",
    label: "Festival",
    emoji: "🎉",
    desc: "Festival or seasonal offer",
  },
      ...
      <div className="flex-1 p-4 animate-fadeIn sm:p-6">
        ...
        <div className="mb-[14px] flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-0.5 text-xs text-text3">
              Reach your customers with offers and updates
            </div>
          </div>
          <button
        ...
        <div className="mb-5 rounded-[10px] border border-border bg-surface shadow-[0_1px_3px_rgba(0,0,0,.07)]">
          ...
          >
            ...
            <span
              className={`text-[10px] text-text3 transition-transform ${showGuide ? "rotate-180" : ""}`}
            >
              ▼
            </span>
          </button>
            ...
            <div className="border-t border-border px-4 py-4">
              ...
              <div className="mb-4">
                ...
                <div className="overflow-hidden rounded-lg border border-border">
                  <div className="grid grid-cols-2 bg-surface2 px-3 py-1.5 text-[10px] font-bold text-text3">
                    <span>Budget</span>
                    <span className="text-right">Customers Reached</span>
                  </div>
                  {[
              ...
              <div className="mb-4 rounded-lg bg-accent-bg/50 p-3">
                ...
                <div className="space-y-1.5 text-xs text-text2 leading-relaxed">
                  <div>
                    Restaurants that send regular campaigns see{" "}
                    <span className="font-bold text-accent">
                      2-3x more returning customers
                    </span>{" "}
                    compared to those that don&apos;t.
                  </div>
                  <div>
                    A simple &quot;10% off this weekend&quot; message can bring
                    back customers who haven&apos;t visited in weeks — turning
                    one-time visitors into regulars.
                  </div>
                  <div className="text-text3">
                    Every returning customer costs ₹0 to acquire. Campaigns just
              ...
              <div className="mb-3">
                ...
                <div className="space-y-2">
                  {[
                    {
                      icon: "🏷",
                      text: "Discount campaigns work best on weekdays when footfall is low",
                    },
                    {
                      icon: "🍽",
                      text: "New dish announcements drive curiosity — add a limited-time tag",
                    },
                    {
                      icon: "🎉",
                      text: "Festival offers get 2-3x more response than regular campaigns",
                    },
                    {
                      icon: "⏰",
                      text: "Send campaigns between 10 AM – 12 PM or 5 PM – 7 PM for best results",
                    },
                    {
                      icon: "📝",
                      text: "Keep messages short, personal, and include a clear offer",
                    },
                  ].map((tip) => (
                    <div
                      key={tip.icon}
                      className="flex items-start gap-2 text-xs text-text3"
                    >
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[11px] text-text3">
                View all sent campaigns and stats
              </div>
            </div>
          </div>
                ...
                <>
                  ...
                  <div className="mb-4">
                    ...
                    <textarea
                      ...
                      value={cMessage}
                      onChange={(e) =>
                        setCMessage(e.target.value.slice(0, 500))
                      }
                    />
                    <div className="mt-[3px] flex justify-between text-[11px] text-text3">
                      <span>
                        Use {"{customerName}"}, {"{restaurantName}"} as
                        variables
                      </span>
              ...
              {step === 3 && draftCampaign && (
                <>
                  <div className="mb-4 rounded-[10px] border border-border bg-surface2 p-3">
                    ...
                    <div className="text-xs text-text2 whitespace-pre-wrap">
                      {draftCampaign.message}
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-semibold">
                        {draftCampaign.audienceCount.toLocaleString()} customers
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-text3">Cost per message</span>
                      <span className="font-semibold">
                        ₹{draftCampaign.costPerMessage.toFixed(2)}
                      </span>
                    </div>
                    <div className="flex justify-between border-t border-border pt-2 text-sm font-bold">
                      <span>Total Cost</span>
                      <span className="text-accent">
                        ₹{draftCampaign.totalCost.toFixed(2)}
                      </span>
                    </div>
                  </div>
