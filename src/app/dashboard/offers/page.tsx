        ...
        <div className="fixed inset-0 z-500 flex items-center justify-center bg-black/40 backdrop-blur-[3px] animate-fadeO" onClick={(e) => e.target === e.currentTarget && setModalOpen(false)}>
          <div className="mx-4 flex max-h-[90vh] w-full max-w-[480px] flex-col overflow-hidden rounded-[14px] bg-surface shadow-[0_20px_60px_rgba(0,0,0,.12)] animate-slideUp sm:mx-0">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-[18px]">
              ...
              <div className="mb-4 flex gap-3">
                <div className="flex-1">
                  <label className="mb-[5px] block text-xs font-semibold text-text2">Start Time</label>
                  <input className="w-full rounded-lg border-[1.5px] border-border bg-surface px-3 py-[9px] text-sm outline-none focus:border-accent" type="time" value={startTime} onChange={(e) => setStartTime(e.target.value)} />
                </div>
                <div className="flex-1">
                  <label className="mb-[5px] block text-xs font-semibold text-text2">End Time</label>
                  <input className="w-full rounded-lg border-[1.5px] border-border bg-surface px-3 py-[9px] text-sm outline-none focus:border-accent" type="time" value={endTime} onChange={(e) => setEndTime(e.target.value)} />
                </div>
              </div>
