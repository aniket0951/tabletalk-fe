const features = [
  {
    ...
    desc: "Customers order on WhatsApp — the app they already use every day. Zero downloads, zero friction.",
  },
  {
    icon: "🤖",
    bg: "#e8f5ee",
    title: "Claude AI Brain",
    desc: 'Understands typos, shorthand, and natural language. "1 butter chikn n 2 naan" works perfectly.',
  },
  {
    icon: "⚡",
    bg: "#eff6ff",
    title: "Instant Notifications",
    desc: "Owner gets WhatsApp ping the moment an order is placed — table number, items, total.",
  },
  {
    icon: "🪑",
    bg: "#f5f3ff",
    title: "Dine-In + Walk-In",
    desc: "QR codes per table for restaurants. Single QR + token system for breakfast centres and canteens.",
  },
  {
    icon: "📊",
    bg: "#fef3c7",
    title: "Live Dashboard",
    desc: "Track every order in real-time. See what's cooking, what's ready, revenue today and this week.",
  },
  {
    icon: "☰",
    bg: "#fef2f2",
    title: "Easy Menu Management",
    desc: "Add, edit, or hide items from your dashboard. Changes reflect instantly on the bot.",
  },
];
